//  Unable to figure out how to complete this problem set due to limited time.
//  The following code was written by someone else, referencce: rishabhs95 on github
